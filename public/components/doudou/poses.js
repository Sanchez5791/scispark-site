...
(function () {
  ...
  /* Mood → pose id mapping. v3.js Doudou system calls Doudou.show(mood).
   * Claude Code MUST verify the actual mood strings used in v3.js boot/submit/streak/
   * lesson-complete code paths and adjust this map if names differ. */
  var MOOD_TO_POSE = {
    default:    'P01',  // idle, between actions
    idle:       'P01',
    start:      'P02',  // hook screen, lesson open
    greeting:   'P02',
    curious:    'P03',  // question shown, waiting for input
    aha:        'P04',  // insight, explanation revealed
    cheer:      'P05',  // mid-lesson encouragement
    encourage:  'P05',
    think:      'P06',  // hint button pressed, thinking pause
    hint:       'P06',
    confused:   'P07',  // wrong answer, first attempt
    wrong:      'P07',
    correct:    'P08',  // right answer → star eye, jump
    right:      'P08',
    star:       'P08',
    point:      'P09',  // pointing to UI element
    listen:     'P10',  // TTS playing
    tts:        'P10',
    examine:    'P11',  // reading content
    read:       'P11',
    sleepy:     'P12',  // long idle, lesson pause
    goodbye:    'P13',  // wrap screen, lesson nearly done
    wrap:       'P13',
    team:       'P14',  // Professor Spark co-appearance moment
    levelup:    'P15',  // streak milestone popup
    streak:     'P15',
    complete:   'P16',  // full lesson complete popup
    // v3.js runtime aliases — appended per E.1 (poses.js is new file, append-safe)
    transition: 'P01',  // screen-change animation → idle
    happy:      'P08',  // submitAnswer fallback alias → star
    thinking:   'P06'   // submitAnswer fallback alias → think
  };

  /* renderDoudou(moodOrPoseId, opts)
   *   moodOrPoseId: mood string ("correct") OR direct pose id ("P08")
   *   opts.size: pixel width (default 120). aspect height preserved.
   *   opts.className: extra class to add on the wrapper.
   * Returns: HTML string with .doudou-pose wrapper. Caller injects via innerHTML.
   */
  ...
  /* Expose vanilla globals (matches v3.js IIFE pattern, no ES modules). */
